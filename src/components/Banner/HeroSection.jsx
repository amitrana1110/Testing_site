...
export default function HeroSection({ data = defaultHeroData }) {
  ...
  return (
    <section className="relative overflow-hidden w-full">
      {/* Optimized Background Image with high loading priority and parallax scrolling */}
      <div 
      ...
      <MaxWidthContainer>
        <div className="w-full flex flex-col lg:flex-row justify-between items-center py-10 lg:py-18 gap-5 lg:gap-0 sm:px-6 lg:px-0">
          {/* LEFT */}
          <ScrollReveal direction="up" duration={800} className="w-full lg:max-w-[520px]">
            <div className="flex flex-col items-start max-lg:items-center gap-4">
              {/* Badge */}
          ...
          {/* RIGHT CARD */}
          <ScrollReveal direction="up" duration={800} delay={200} className="w-full lg:max-w-[651px]">
            <div className="flex flex-col items-start gap-2.5 lg:gap-6 bg-surface rounded-2xl px-3 py-5 lg:py-6 lg:px-4.75 border border-border">
              <div>
