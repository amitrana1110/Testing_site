...
export default function AboutSection({ data = defaultAboutData }) {
  ...
  return (
    <MaxWidthContainer>
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center mt-2 lg:my-11 gap-6 lg:gap-0">
        {/* Left: Image */}
        ...
        {/* Right: Content */}
        <ScrollReveal direction="right" duration={800} delay={150} className="w-full">
            ...
            <div className="grid grid-cols-3 gap-4 lg:gap-8 mt-2 lg:mt-3">
              {stats.map((stat) => (
                <div key={stat.label} className="flex flex-col">
                  <span className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-text-primary leading-normal">
                    {stat.value}
                  </span>
