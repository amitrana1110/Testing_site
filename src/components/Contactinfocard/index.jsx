  ...
  return (
    <MaxWidthContainer>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-5 mt-2 lg:mt-11">
        {cards.map(({ id, icon, title, description, value, locations }, index) => (
          <ScrollReveal key={title} delay={index * 150} direction="up">
            <div
              className="flex flex-col items-center text-center gap-1 lg:gap-2 bg-surface border border-border rounded-2xl px-4 py-6 lg:py-8 h-full"
            >
              <div
