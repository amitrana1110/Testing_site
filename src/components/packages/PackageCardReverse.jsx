...
/**
 * PackageCardReverse
 * Same as PackageCard but with the image carousel on the right
 * and content on the left (used for Do Dham Yatra).
 *
 * @param {{ pkg: import('../data/doDham').doDham }} props
 */
export default function PackageCardReverse({ pkg }) {
  const {
    badge,
    title,
    price,
      ...
      <ScrollReveal direction="up" duration={800}>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-[58%_42%]">
            {/* ── Left: Content ── */}
            <div className="flex flex-col gap-3 lg:gap-7 lg:p-5 md:overflow-y-auto order-2 md:order-1">
              {/* Header: title + price */}
            ...
            <div className="relative md:min-h-[520px] order-1 md:order-2">
